...
def main():
    ...
    #x_train  入力（学習データ）
    #y_train  出力（教師データ）
    dataset = np.loadtxt('/home/soma1/Documents/noboru/csv/9_tree_detection_train.csv', delimiter=',', comments='#')
    x_train = dataset[:, 3:9]
    #x_train = dataset[:, 0:9]
    ...
    # テスト用データ
    test_data = np.loadtxt('/home/soma1/Documents/noboru/csv/9_tree_detection_test.csv', delimiter=',', comments='#')
    ...
    model_alpha.save('/home/soma1/Documents/noboru/model/9_alpha.h5')
    model_beta.save('/home/soma1/Documents/noboru/model/9_beta.h5')
    model_gamma.save('/home/soma1/Documents/noboru/model/9_gamma.h5')
