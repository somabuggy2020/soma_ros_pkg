...
class Neural_Network():
  ...
  def rotate_cood(self):
    ...
    x_set = np.arange(3.00, 3.01, 1)
    y_set = np.arange(2.55, 2.56, 1)
  ...
  def write_csv(self):
    with open('/home/soma1/Documents/noboru/csv/tree_detection_test.csv', 'w') as file:
      ...
      for a in range(len(self.q_set)):
        writer.writerow([self.q_set[a][0], self.q_set[a][1], self.q_set[a][2],
                         ...
                         self.PROB[a][0][0], self.PROB[a][0][1], self.PROB[a][0][2], self.PROB[a][0][3],
                         self.PROB[a][1][0], self.PROB[a][1][1], self.PROB[a][1][2], self.PROB[a][1][3],
                         self.PROB[a][2][0], self.PROB[a][2][1], self.PROB[a][2][2], self.PROB[a][2][3]])
